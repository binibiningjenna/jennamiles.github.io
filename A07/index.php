...
if (isset($_POST['btnCreatePost'])) {
  ...
  // Insert into posts table using the retrieved userID, cityID, and provinceID
...
if (isset($_POST['btnDelete'])) {
  ...
  $detailsResult = executeQuery($detailsQuery);
  ...
  if ($details) {
    ...
    executeQuery($deleteClientQuery);
  ...
  <div class="container-fluid my-5">
    <div class="row justify-content-center">
      <div class="col-12 col-md-6 d-flex justify-content-center">
        <button type="button" onclick="togglePostForm()" class="btn btn-warning w-50 w-md-auto"
          id="categoryButton">Create Post</button>
      </div>
    </div>
  </div>
    ...
    <form method="POST">
      <div class="row justify-content-center">
        <div class="col-12 col-sm-8">
          ...
          <button type="submit" class="btn btn-warning mb-2 w-25 w-sm-auto fw-bold" name="btnCreatePost"
            id="categoryButton">Post</button>
        </div>
      </div>
    </form>
  </div>
          ...
          <div class="col-lg-8 col-md-6 col-sm-10">
            <div class="card m-1">
              <div class="card-header d-flex align-items-center">
                <img src="https://icon-library.com/images/profile-picture-icon/profile-picture-icon-0.jpg"
                  alt="Profile Picture" class="profile-pic" style="width: 40px; height: 40px;">
                <h5 class="ml-3 px-2"><?php echo $post['username']; ?></h5>
              </div>
              <div class="card-body p-0">
                <p class="card-text pt-3 px-3"><?php echo $post['content']; ?></p>
                <p class="location px-3"><i class="fas fa-map-marker-alt"></i>
                  <?php echo $post['city_name'] . ', ' . $post['province_name']; ?></p>
              </div>
              <div class="card-footer text-right">
                <div class="d-flex justify-content-between">
                  ...
                  <div class="d-flex justify-content-start align-items-center">
                    <a href="view.php?id=<?php echo $post['postID'] ?>">
                      <button class="btn btn-dark btn-edit fw-bold regular-text">Edit</button>
                    </a>
                    <form method="POST">
            ...
            <div class="profile-card shadow-sm rounded bg-light">
              <div class="wrapper px-4 py-4 text-center">
                ...
                <div class="profile-info text-center pt-4">
                  <img src="https://icon-library.com/images/profile-picture-icon/profile-picture-icon-0.jpg"
                    class="rounded-circle border" alt="Profile Picture" width="200" height="200">
                  <h1 id="first-name" class="first-name subheader display-4 mt-3 mb-0 fw-bold">
